...
//		            			System.out.println(mCharacteristicRingBuffer.size());
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt,
            ...
            if (valor == true) {
                ...
                edit = sp.edit();
                edit.putString("valorrecibido", "1");
                edit.commit();
                valor = false;
            } else if (valor == false){
                ...
                sp = getSharedPreferences("MyPrefs", MODE_PRIVATE);
                edit = sp.edit();
                edit.putString("valorrecibido", "0");
                edit.commit();
                valor = true;
            }

            //System.out.println("onCharacteristicChanged  "+new String(characteristic.getValue()));
            //String valor = new String(characteristic.getValue());
            //Esta es la línea que comenté para que me funcionara en esta API
            //broadcastUpdate(ACTION_DATA_AVAILABLE, characteristic);
            //sp = getSharedPreferences("MyPrefs", MODE_PRIVATE);
            //edit = sp.edit();
            //        edit.putString("valorrecibido", valor);
            //edit.commit();
